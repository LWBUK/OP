...
/*  SUPER ADMIN HERE      */ _SAdmins = ["76561198028236135","76561198302675871","76561198053418320","76561198312597166","76561197962108622"]; //do not have a , at the end.
...
/* ********************************************************************************* */
/*  Top esc menu TXT      */ _TopOfESC = "Survivalist DayZ"; //do not use " in this text.
/*  Bottom esc menu TXT   */ _LowerTop = "Survivalist-dayz.com"; //do not use " in this text.
/*  Bottom esc menu TXT2  */ _LowerBottom = "TS3.78.31.67.100"; //do not use " in this text.
/*  Color esc menu TXT    */ _EscColor = [0.6,0,0,1];
/*  DebugMonitor TXT      */ _BottomDebug = "SURVIVALIST-DAYZ.COM"; //do not use " in this text.
...
_ALLOWED_Dialogs = _ALLOWED_Dialogs + [81000,88890,20001,20002,20003,20004,20005,20006,55510,55511,55514,55515,55516,55517,55518,55519,555120,118338,118339,571113,20001,81000,88890,20001,20002,20003,20004,20005,20006,55510,55511,55514,55515,55516,55517,55518,55519,555120,118338,118339,711197,711195,76761,571113,50003,50004,8101]; // adding some others from community addons
...
[
	...
	"s_player_upgradestorage","s_player_upgradestroage","s_player_warndog","s_player_waterdog","s_player_zombieShield","s_player3275_copyToKey",
	...
	"Tow_settings_dlg_CV_btn_fermer","Tow_settings_dlg_CV_titre","unpackRavenAct","vectorActions","wardrobe","s_bank_dialog"
];
/* ********************************************************************************* */
	//	NEW (EXPERIMENTAL):
