...
copy "%arma2srvpath%\%servername%\arma2oaserver1061.RPT" "%arma2srvpath%\%servername%\RotatedLogs\%dtStamp%\arma2oaserver1061.RPT"
copy "%arma2srvpath%\%servername%\arma2oaserver1061.mdmp" "%arma2srvpath%\%servername%\RotatedLogs\%dtStamp%\arma2oaserver1061.mdmp"
copy "%arma2srvpath%\%servername%\arma2oaserver1061.bidmp" "%arma2srvpath%\%servername%\RotatedLogs\%dtStamp%\arma2oaserver1061.bidmp"
copy "%arma2srvpath%\%servername%\server_logOP.txt" "%arma2srvpath%\%servername%\RotatedLogs\%dtStamp%\server_logOP.txt"
...
del /Q /F "%arma2srvpath%\%servername%\arma2oaserver1061.RPT"
del /Q /F "%arma2srvpath%\%servername%\arma2oaserver1061.mdmp"
del /Q /F "%arma2srvpath%\%servername%\arma2oaserver1061.bidmp"
